        ...
        <div class="col-xl-3 col-md-6 v_cari" data-filter-name="<?php echo strtolower($dokter->nama) ?>">
          <div class="icon-box">
            ...
            <center>
              ...
              <a href="<?= base_url() . "pendaftaran/jadwal/" . $klinik->id . "/" . $layanan->id_layanan . "/" . $value ?>" class="btn btn-primary" style="background: #4c879a;border-color: #4c879a;">Pilih Dokter <img src="<?php echo base_url() . 'assets/dist/icon/dokter.svg'; ?>" style="width: 25px;" alt=""></a>
            </center>
          </div>
        </div>
      <?php endforeach; ?>
